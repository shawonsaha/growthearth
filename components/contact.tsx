          ...
          <div className="space-y-8">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">01339-871370</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">nawabexporter@gmail.com</p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  House-783, Bagmara, Nawabganj, Dhaka-1320
                </p>
              </div>
            </div>
            <div className="pt-4 flex gap-4">
              <a
                href="https://wa.me/8801339871370"
